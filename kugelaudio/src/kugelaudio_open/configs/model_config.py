...
class KugelAudioConfig(PretrainedConfig):
    ...
    sub_configs = {
        ...
        "semantic_tokenizer_config": KugelAudioSemanticTokenizerConfig,  # PATCH: added
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # PATCH: semantic_tokenizer_config initialised.
        # kugelaudio_model.py can instantiate semantic_tokenizer and expose semantic_vae_dim.
        ...
        # PATCH: semantic_vae_dim exposed so inference code can reference it without
        # hardcoding 128 — used in _process_speech_inputs() dummy mode and time alignment.
